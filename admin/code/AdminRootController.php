...
{
    /**
     * The url base that all LeftAndMain derived panels will live under. Won't automatically update
     * the base route if you change this - that has to be done separately.
     *
     * @var string
     *
     * @config
    ...
    /**
     * The LeftAndMain child that will be used as the initial panel to display if none is selected,
     * like when you visit "/admin".
     *
     * @var string
     *
     * @config
    ...
    /**
     * Holds an array of url_pattern => controller k/v pairs, the same as Director::rules. However
     * this is built dynamically from introspecting on all the classes that derive from LeftAndMain.
     *
     * Don't access this directly - always access via the rules() accessor below, which will build
    ...
    {
        // If this is the final portion of the request, like when you visit "/admin", direct to the
        // default panel.
