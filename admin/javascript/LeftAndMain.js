...
(function($) {
	...
	$.entwine('ss', function($) {
		...
		$('.cms-container').entwine({
			 ...
			 *  - {boolean} replace Forces the replacement of the current history state, even if the URL is the same, i.e. allows reloading.
			 */
			loadPanel: function(url, title, data, replace) {
				if(!data) data = {};
				if(!title) title = "";
