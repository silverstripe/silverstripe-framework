...
$.entwine('ss', function ($) {
  ...
  $('.cms-panel.cms-menu').entwine({
    ...
    getEvaluatedCollapsedState: function () {
      var shouldCollapse
      var manualState = this.getPersistedCollapsedState()
      var menuIsSticky = $('.cms-menu').getPersistedStickyState()
      var automaticState = this.siteTreePresent()
  ...
  $('.cms-menu .sticky-toggle').entwine({
    onadd: function () {
      var isSticky = Boolean($('.cms-menu').getPersistedStickyState())
    ...
    onclick: function () {
      ...
      var persistedCollapsedState = $menu.getPersistedCollapsedState()
      var persistedStickyState = $menu.getPersistedStickyState()
      var newStickyState = persistedStickyState === void 0 ? !this.hasClass('active') : !persistedStickyState
