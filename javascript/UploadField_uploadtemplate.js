			...
			'<div class="ss-uploadfield-item-info">' +
				...
				'<div class="ss-uploadfield-item-actions">' + 
					'{% if (!file.error) { %}' +						
						...
						'{% } %}' +
					'{% } %}' + 	
					'<div class="ss-uploadfield-item-cancel cancel"><button class="icon icon-16" data-icon="minus-circle" title="' + ss.i18n._t('UploadField.CANCELREMOVE', 'Cancel/Remove') + '">' + ss.i18n._t('UploadField.CANCELREMOVE', 'Cancel/Remove') + '</button></div>' +
				'</div>' +
			'</div>' +
		'</li>' + 
	'{% } %}'
