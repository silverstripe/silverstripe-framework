...
class UploadField extends FileField {
	...
	public function canPreviewFolder() {
		...
		$can = $this->ufConfig['canPreviewFolder'];
	...
	public function setCanPreviewFolder($canPreviewFolder) {
		$this->ufConfig['canPreviewFolder'] = $canPreviewFolder;
		return $this;
	}
	...
	/**
	 * Retrieves the list of {@see File} objects attached to this field, whether
	 * this field is saved or not.
	 * 
	 * @return SS_List
	 */
	 ...
	 * 
	 * @deprecated since version 3.2 Use set{Key}() setters instead
	 * 
	 * @param string $key
	 * @param mixed $val
	 * @return UploadField self reference
	...
	public function setConfig($key, $val) {
		Deprecation::notice('3.2', 'Use UploadField::set'.ucwords($key).'($val) instead');
	 ...
	 * 
	 * @deprecated since version 3.2 Use get{Key}() getters instead
	 * @param string $key
	 * @return mixed
	 */
	public function getConfig($key) {
		Deprecation::notice('3.2', 'Use UploadField::get'.ucwords($key).'() instead');
	...
	public function getAutoUpload() {
		return $this->ufConfig['autoUpload'];
	}
	...
	public function setAutoUpload($autoUpload) {
		$this->ufConfig['autoUpload'] = $autoUpload;
		return $this;
	}
	...
	public function getAllowedMaxFileNumber() {
		$allowedMaxFileNumber = $this->ufConfig['allowedMaxFileNumber'];
	...
	public function setAllowedMaxFileNumber($allowedMaxFileNumber) {
		$this->ufConfig['allowedMaxFileNumber'] = $allowedMaxFileNumber;
		return $this;
	}
	...
	public function setCanUpload($canUpload) {
		$this->ufConfig['canUpload'] = $canUpload;
		return $this;
	}
	...
	public function canAttachExisting() {
		if(!$this->isActive()) return false;
		$can = $this->ufConfig['canAttachExisting'];
		return (is_bool($can)) ? $can : Permission::check($can);
	}
	...
	public function setCanAttachExisting($canAttachExisting) {
		$this->ufConfig['canAttachExisting'] = $canAttachExisting;
		return $this;
	}
	...
	public function getPreviewMaxWidth() {
		return $this->ufConfig['previewMaxWidth'];
	}
	...
	public function setPreviewMaxWidth($previewMaxWidth) {
		$this->ufConfig['previewMaxWidth'] = $previewMaxWidth;
		return $this;
	}
	...
	public function getPreviewMaxHeight() {
		return $this->ufConfig['previewMaxHeight'];
	}
	...
	public function setPreviewMaxHeight($previewMaxHeight) {
		$this->ufConfig['previewMaxHeight'] = $previewMaxHeight;
		return $this;
	}
	...
	public function getUploadTemplateName() {
		return $this->ufConfig['uploadTemplateName'];
	}
	...
	public function setUploadTemplateName($uploadTemplateName) {
		$this->ufConfig['uploadTemplateName'] = $uploadTemplateName;
		return $this;
	}
	...
	public function getDownloadTemplateName() {
		return $this->ufConfig['downloadTemplateName'];
	}
	...
	public function setDownloadTemplateName($downloadTemplateName) {
		$this->ufConfig['downloadTemplateName'] = $downloadTemplateName;
		return $this;
	}
