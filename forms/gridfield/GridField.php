...
class GridField extends CompositeField {
	...
	/**
	 * Ask every field if they would like to add extra columns to the table.
	 * 
	 * I.e: actions buttons etc.
	 *
	 * @return int 
	 */
	...
	/**
	 * This will return a count of the column width of the table, usable for colspans.
	 *
	 * @return int 
	 */
	...
	/**
	 * Set the sortable headers, the normal body, the paginator and the filter
	 * 
	 */
	protected function setDefaultFieldElements() {
	...
	public function FieldHolder() {
		...
		foreach($this->FieldList() as $subfield) {
			...
			if ($subfield instanceof GridFieldRowSet) {
				$location = $subfield->stat('location');
			}
