...
$lang['fr_FR']['File']['NOVALIDUPLOAD'] = 'Le fichier n’est pas valide pour le téléversement';
...
$lang['fr_FR']['FileIFrameField']['ATTACHONCESAVED'] = '%ss peut être joint une fois que l’enregistrement a été sauvegardé une première fois. ';
...
$lang['fr_FR']['RemoveOrphanedPagesTask']['CHOOSEOPERATION'] = 'Choisissez l’opération :';
...
$lang['fr_FR']['SiteTree']['VIEW_ALL_HELP'] = 'Possibilité de voir toutes les pages du site, peu importe les réglages de l’onglet Accès. Nécessite la permission "Access to Site Content"';
...
$lang['fr_FR']['VirtualPage']['NOTFOUND'] = 'Nous n’avons pas pu trouver le contenu pour cette page virtuelle.';
