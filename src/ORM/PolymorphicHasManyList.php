...
class PolymorphicHasManyList extends HasManyList
{
     ...
     * @param string $foreignRelation The name of the has_many relation this list is filtered by, if any.
     */
    public function __construct(string $dataClass, string $foreignField, string $foreignClass, ?string $foreignRelation = null)
    {
        ...
        if ($foreignRelation !== null) {
            ...
            $this->dataQuery->where([$foreignRelationColumn => $foreignRelation]);
            $this->dataQuery->setQueryParam('Foreign.Relation', $foreignRelation);
        }
