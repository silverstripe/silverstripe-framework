...
class Security extends Controller implements TemplateGlobalProvider
{
     ...
     * @return Member
     *
     * @deprecated 4.0.0 Please use DefaultAdminService::findOrCreateDefaultAdmin()
     */
     ...
     *
     * @deprecated 4.0.0 Please use DefaultAdminService::clearDefaultAdmin()
     */
     ...
     *
     * @deprecated 4.0.0 Please use DefaultAdminService::setDefaultAdmin($username, $password)
     */
     ...
     *
     * @deprecated 4.0.0 Use DefaultAdminService::hasDefaultAdmin() instead
     */
     ...
     *
     * @deprecated 4.0.0 Use DefaultAdminService::getDefaultAdminPassword()
     * @return string
     */
     ...
     *
     * @deprecated 4.4.0 Use CryptographicHashService or PasswordHashService instead
     */
    public static function encrypt_password($password, $salt = null, $algorithm = null, $member = null)
    {
        Deprecation::notice('5.0.0', 'Please use CryptographicHashService or PasswordHashService instead');
