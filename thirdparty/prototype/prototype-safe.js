...
Object.extend(Number.prototype, {
  ...
  times: function(iterator) {
    $Range(0, this, true).each(iterator);
    return this;
  }
});
...
var Enumerable = {
  ...
  zip: function() {
    var iterator = Prototype.K, args = $Array(arguments);
    if (typeof args.last() == 'function')
      iterator = args.pop();

    var collections = [this].concat(args).map($Array);
...
var $Array = Array.from = function(iterable) {
  if (iterable.toArray) {
...
var Hash = {
  ...
  merge: function(hash) {
    return $Hash(hash).inject($Hash(this), function(mergedHash, pair) {
...
document.getElementsByClassName = function(className, parentElement) {
  ...
  return $Array(children).inject([], function(elements, child) {
...
Abstract.Insertion.prototype = {
  ...
  contentFromAnonymousTable: function() {
    ...
    return $Array(div.childNodes[0].childNodes[0].childNodes);
  }
}
...
/*--------------------------------------------------------------------------*/
var $Form = Form.Element.getValue;
/*--------------------------------------------------------------------------*/
