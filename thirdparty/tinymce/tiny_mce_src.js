...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		resizeToContent : function() {
			var t = this;
			if(t.minHeight == null) t.minHeight = parseInt(DOM.getStyle(t.id + "_ifr", 'height'));
			DOM.setStyle(t.id + "_ifr", 'height', t.minHeight > t.getBody().scrollHeight ? t.minHeight : t.getBody().scrollHeight);
		},
