...
class FulltextFilterTest extends SapphireTest {
	...
	public function testGenerateQuery() {
		...
		$this->assertNotEquals('"ColumnA","ColumnB"', $filter1->getDbName($query1));
		...
		$query1 = FulltextFilterTest_DataObject::get()->dataQuery();
		$filter1->apply($query1);
		$this->assertEquals('"FulltextFilterTest_DataObject"."ColumnA","FulltextFilterTest_DataObject"."ColumnB"', $filter1->getDbName($query1));
		$this->assertEquals(
		...
		$this->assertEquals('"FulltextFilterTest_DataObject"."ColumnC","FulltextFilterTest_DataObject"."ColumnD"', $filter2->getDbName($query2));
		$this->assertEquals(
		...
		$this->assertEquals('"FulltextFilterTest_DataObject"."ColumnA"', $filter3->getDbName($query3));
		$this->assertEquals(
