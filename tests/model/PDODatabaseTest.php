...
use SilverStripe\Model\Connect\PDOConnector;
class PDODatabaseTest extends SapphireTest {
	...
	public function testPreparedStatements() {
		...
		$this->assertInstanceOf('SilverStripe\Model\Connect\PDOQuery', $result1);
		$this->assertInstanceOf('SilverStripe\Model\Connect\PDOQuery', $result2);
		...
		$this->assertInstanceOf('SilverStripe\Model\Connect\PDOQuery', $result3);
	...
	public function testAffectedRows() {
		...
		$this->assertInstanceOf('SilverStripe\Model\Connect\PDOQuery', $result);
