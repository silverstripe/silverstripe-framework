...
use SilverStripe\Model\Connect\MySQLiConnector;
...
class MySQLDatabaseTest extends SapphireTest {
	...
	public function testPreparedStatements() {
		...
		$this->assertInstanceOf('SilverStripe\Model\Connect\MySQLStatement', $result1);
		$this->assertInstanceOf('SilverStripe\Model\Connect\MySQLStatement', $result2);
		...
		$this->assertInstanceOf('SilverStripe\Model\Connect\MySQLQuery', $result3);
	...
	public function testAffectedRows() {
		...
		$this->assertInstanceOf('SilverStripe\Model\Connect\MySQLQuery', $result);
