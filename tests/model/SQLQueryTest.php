...
class SQLQueryTest extends SapphireTest {
	...
	public function testParameterisedInnerJoins() {
		$query = new SQLSelect();
		$query->setSelect(['"SQLQueryTest_DO"."Name"', '"SubSelect"."Count"']);
		$query->setFrom('"SQLQueryTest_DO"');
		$query->addInnerJoin(
		...
		$query->addWhere(['"SQLQueryTest_DO"."Date" > ?' => '2012-08-08 12:00']);
	...
	public function testDeprecatedGetWhere() {
		...
		$query = new SQLQuery();
		$query->setSelect(['"SQLQueryTest_DO"."Name"']);
		$query->setFrom('"SQLQueryTest_DO"');
		$query->addWhere([
		...
		$query->addWhere([
			'"SQLQueryTest_DO"."Meta" IN (?, \'Who?\', ?)' => ['Left', 'Right']
		]);
...
EOS
			;
		$expectedParameters = ['2012-08-08 12:00', 'Left', 'Right'];
	...
	public function testDeprecatedSetDelete() {
		...
		$query->setSelect(['"SQLQueryTest_DO"."Name"']);
		$query->setFrom('"SQLQueryTest_DO"');
		$query->setWhere(['"SQLQueryTest_DO"."Name"' => 'Andrew']);
...
EOS
		...
		$this->assertEquals(['Andrew'], $parameters);
