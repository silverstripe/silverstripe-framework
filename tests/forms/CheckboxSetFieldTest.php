...
class CheckboxSetFieldTest extends SapphireTest {
	...
	public function testSavingIntoTextField() {
		$field = new CheckboxSetField('Content', 'Content', [
			'Test' => 'Test',
			'Another' => 'Another',
			'Something' => 'Something'
		]);
	...
	public function testValidationWithArray() {
		...
		$field = CheckboxSetField::create('Test', 'Testing', [
			"One" => "One",
			"Two" => "Two",
			"Three" => "Three"
		]);
		$validator = new RequiredFields();
		$field->setValue(["One" => "One", "Two" => "Two"]);
		$this->assertTrue(
		...
		$field->setValue(["One" => "One", "Two" => "Two", "Four" => "Four"]);
		$this->assertTrue(
			$field->validate($validator),
