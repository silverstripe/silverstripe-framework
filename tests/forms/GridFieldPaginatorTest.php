...
class GridFieldPaginatorTest extends SapphireTest {
	...
	public function testFieldHolder() {
		...
		$t = $gfb->FieldHolder();
		$this->assertContains('<button class="action  nolabel" id="action_SetPage1" type="submit" name="action_gridFieldAlterAction?StateID=', $t);
	...
	public function testFieldHolderTwoPages() {
		...
		$this->assertContains('<button class="action  nolabel" id="action_SetPage1" type="submit" name="action_gridFieldAlterAction?StateID=', $html);
		$this->assertContains('">1</button>', $html);
		$this->assertContains('<button class="action  nolabel" id="action_SetPage2" type="submit" name="action_gridFieldAlterAction?StateID=', $html);
		$this->assertContains('">2</button></td></tr>', $html);
	}
