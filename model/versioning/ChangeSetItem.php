...
class ChangeSetItem extends DataObject implements CMSPreviewable {
	 ...
	 * @return Versioned|DataObject
	 */
	protected function getLatestObject() {
	...
	public function Link() {
		foreach([Versioned::DRAFT, Versioned::LIVE] as $stage) {
			$object = $this->getObjectInStage($stage);
			if($object && $object instanceof CMSPreviewable) {
				return Controller::join_links($object->Link(), "?stage=\"{$stage}\"");
			}
		}
		return null;
	}
