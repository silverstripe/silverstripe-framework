 ...
 * @subpackage model
 */
class SQLQuery extends SQLConditionalExpression {
	 ...
	 * @return SQLQuery A clone of this object with the given aggregate function
	 */
	 ...
	 *
	 * @return SQLQuery A clone of this object with the first row only
	 */
	 ...
	 *
	 * @return SQLQuery A clone of this object with the last row only
	 */
