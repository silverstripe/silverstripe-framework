...
Compass has been removed and css/sprite compilation is now handled with gulp (see [Markup and Style Conventions](../developer_guides/customising_the_admin_interface/cms_architecture/#markup-and-style-conventions)).
