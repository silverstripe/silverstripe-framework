...
![File indicators](https://raw.githubusercontent.com/silverstripe/silverstripe-framework/blob/4/docs/en/04_Changelogs/_images/file-indicators.png "A screenshot of file indicators being displayed in the file manager")
