...
Performs a GET request on $url and retrieves the [api:SilverStripe\Control\HTTPResponse]. This also changes the current page to the value
of the response.
...
Performs a POST request on $url and retrieves the [api:SilverStripe\Control\HTTPResponse]. This also changes the current page to the value
of the response.
...
Submits the given form (`#ContactForm`) on the current page and returns the [api:SilverStripe\Control\HTTPResponse].
