...
[api:SilverStripe\Forms\Form] and [api:SilverStripe\Forms\FormField] instances can be turned into a read-only version for things like confirmation pages or 
...
To make an entire [api:SilverStripe\Forms\Form] read-only.
