...
encapsulated by [api:SilverStripe\ORM\HasManyList] and [api:SilverStripe\ORM\ManyManyList], both of which provide very similar APIs, e.g. an `add()`
and `remove()` method.
...
* [api:SilverStripe\ORM\HasManyList]
* [api:SilverStripe\ORM\ManyManyList]
