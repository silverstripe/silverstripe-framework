...
See the [API documentation](api:DBField) for a full list of available Data Types. You can define your own [api:SilverStripe\ORM\FieldType\DBField] instances if required as well. 
...
If this case, we'll create a new method for our `Player` that returns the full name. By wrapping this in a [api:SilverStripe\ORM\FieldType\DBVarchar]
...
instance of the [api:SilverStripe\ORM\FieldType\DBField] class, providing additional helpers. For example, a string can be cast as a [api:SilverStripe\ORM\FieldType\DBText] 
...
Of course that's much more verbose than the equivalent PHP call. The power of [api:SilverStripe\ORM\FieldType\DBField] comes with its more 
...
The database field types [api:SilverStripe\ORM\FieldType\DBHTMLVarchar]/[api:SilverStripe\ORM\FieldType\DBHTMLText] and [api:SilverStripe\ORM\FieldType\DBVarchar]/[api:SilverStripe\ORM\FieldType\DBText] are exactly the same in 
...
* [api:SilverStripe\ORM\FieldType\DBField]
