...
This example deals with breaking up a [api:SilverStripe\ORM\SS_List] into sub-headings by the first letter.
...
and pass that to the [api:SilverStripe\ORM\GroupedList::GroupedBy()] call.
...
The final step is the render this into the template using the [api:SilverStripe\ORM\GroupedList::GroupedBy()] method.
