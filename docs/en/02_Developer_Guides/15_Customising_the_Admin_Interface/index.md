...
module. The main class for displaying the interface is a specialized [api:SilverStripe\Control\Controller] called [api:SilverStripe\Admin\LeftAndMain], named
