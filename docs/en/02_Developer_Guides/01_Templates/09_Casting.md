...
output the result of the [api:SilverStripe\ORM\FieldType\DBHtmlText::FirstParagraph()] method to the template.
...
See the API documentation for [api:SilverStripe\ORM\FieldType\DBHtmlText], [api:SilverStripe\ORM\FieldType], [api:SilverStripe\ORM\FieldType\DBText] for all the methods you can use to format 
