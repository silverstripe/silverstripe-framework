...
This is my `_ss_environment.php` file. I have it placed in `/var`, as each of the sites are in a subfolder of `/var`.
	...
	// This causes errors to be written to the silverstripe.log file in the webroot
	// You can use relative paths to get elsewhere (e.g. '../silverstripe.log' to get one level above web-root)
...
| `SS_ERROR_LOG` | String. Path to the error log file (e.g. 'silverstripe.log', '../ss-errors.log') |
