...
To accomplish this, we have added a specific [api:SilverStripe\Forms\GridField\GridFieldConfig].
 ...
 * Change the `GridField` to list only five records per page (the default is 20).
   This configuration is stored in the [api:SilverStripe\Forms\GridField\GridFieldPaginator] component
