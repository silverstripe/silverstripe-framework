...
const Chevron: StatelessComponent<ChevronProps> = ({ dir }): ReactElement => {
    return (
        <svg viewBox="0 0 926.23699 573.74994" version="1.1" x="0px" y="0px" width="15" height="15" style={{ transform: `rotate(${dir === 'up' ? '180deg' : '0'})`}}>
